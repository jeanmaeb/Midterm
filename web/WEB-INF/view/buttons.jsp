<%-- 
    Document   : buttons
    Created on : Mar 25, 2024, 9:41:52 PM
    Author     : user
--%>
...
.fnc-slide-1 .fnc-slide__mask-inner {
  background-image: url('https://scontent-mnl1-1.xx.fbcdn.net/v/t39.30808-6/345457927_191309983792989_5393623817676607669_n.jpg?_nc_cat=100&ccb=1-7&_nc_sid=5f2048&_nc_eui2=AeGoaGzZc45M81yCauTYO0vdS7HLWKOh6fdLsctYo6Hp94ft96r2c3ETmvlJ-6PXZzWtcOxBX6gBArDYnPR5BrXO&_nc_ohc=aAZ9hQr5-rcAb7IEEes&_nc_ht=scontent-mnl1-1.xx&oh=00_AfBHvGXY4kCMLjU-rMtGW4eEBNUDTmxeEW8sHb4upwj0Fw&oe=66170973');
}

.fnc-slide-2 .fnc-slide__inner,
.fnc-slide-2 .fnc-slide__mask-inner {
  background-image: url('https://buffer.com/library/content/images/size/w1200/2023/10/free-images.jpg');
}
...
<div class="demo-cont">
  ...
  <div class="demo-cont__credits">
    ...
    <h3 class="demo-cont__credits-name">Joshua D. Talaid</h3>
    <a href="https://joshuatalaid.github.io/JavaWebApplication/" target="_blank" class="demo-cont__credits-link">
        About Me</a>
    <a href="/button1" target="_blank" class="demo-cont__credits-link">
        Image Display</a>
    <a href="/button2" target="_blank" class="demo-cont__credits-link">
        GIF Display</a>
    <a href="/button3" class="demo-cont__credits-link">
        Secret Message</a>
